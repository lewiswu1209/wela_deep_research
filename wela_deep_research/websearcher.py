...
class WebSearcher(StatefulAgent):
    ...
    def __init__(self, *, state: ReportState, proxies: Dict[str, str], google_api_key: str, cx: str, num_of_result=3, input_key: str, output_key: str):
        ...
        for query in queries_list:
            try:
                ...
                response = requests.get(
                    f"https://www.googleapis.com/customsearch/v1?q={query}+-filetype:pdf&key={self.__google_api_key}&cx={self.__cx}&num={self.__num_of_result}",
